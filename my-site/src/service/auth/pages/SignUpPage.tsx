...
export default function SignUpPage() {
    ...
    return (
      <div className="max-w-md mx-auto mt-12">
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-2">회원가입 완료</h2>
  ...
  return (
    <div className="max-w-md mx-auto mt-12">
      <h1 className="text-3xl font-extrabold text-blue-900 dark:text-blue-300 mb-6 tracking-tight">회원가입</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
        ...
        <div className="mb-4">
          <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-2">닉네임</label>
          <input
            type="text"
            value={nickname}
        ...
        <div className="mb-6">
          ...
          <input
            ...
            required
          />
          <p className="text-xs text-gray-400 dark:text-slate-400 mt-1">6자 이상 입력해주세요.</p>
        </div>
